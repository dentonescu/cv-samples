...
class Settings(BaseSettings):
    ...
    auth_method: Literal["native", "oidc"] = AUTH_METHOD_NATIVE  # PKIXWA_AUTH_METHOD
    ...
    model_config = (
        SettingsConfigDict(**MODEL_CONFIG) if SettingsConfigDict else MODEL_CONFIG
    )
